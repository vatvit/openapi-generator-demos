...
class SecurityValidator
{
    ...
    private static array $securitySchemes = [
        ...
        // Additional security schemes would be listed here:
        // 'apiKey' => ApiKeyAuthenticationInterface::class,
        // 'oauth2' => OAuth2AuthenticationInterface::class,
    ];
    ...
    private static array $operationSecurity = [
        ...
        // Additional operations would be listed here:
        // 'deleteGame' => ['bearerHttpAuthentication'],
        // 'getBoard' => ['apiKey', 'oauth2'], // OR logic
    ];
