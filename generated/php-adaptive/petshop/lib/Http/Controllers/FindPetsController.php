...
/**
 * Controller for findPets operation.
 *
 ...
 */
final class FindPetsController
{
    public function __construct(
        private readonly SearchHandlerInterface $handler
    ) {}

    /**
     * Handle the findPets request.
     *
     * @param FindPetsRequest $request The validated request
     * @return JsonResponse
     */
