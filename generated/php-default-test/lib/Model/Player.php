    ...
    */
    ...
    public function setUsername($username)
    {
        ...
        if ((mb_strlen($username) > 50)) {
            throw new \InvalidArgumentException('invalid length for $username when calling Player., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($username) < 3)) {
            throw new \InvalidArgumentException('invalid length for $username when calling Player., must be bigger than or equal to 3.');
        }
        if ((!preg_match("/^[a-zA-Z0-9_-]+$/", ObjectSerializer::toString($username)))) {
            throw new \InvalidArgumentException("invalid value for \$username when calling Player., must conform to the pattern /^[a-zA-Z0-9_-]+$/.");
        }
     ...
     * Sets display_name
     *
     * @param string|null $display_name Player display name
     *
     * @return self
     */
    public function setDisplayName($display_name)
    {
        ...
        if ((mb_strlen($display_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $display_name when calling Player., must be smaller than or equal to 100.');
        }
     ...
     * Sets avatar_url
     *
     * @param string|null $avatar_url URL to player avatar image
     *
     * @return self
     */
