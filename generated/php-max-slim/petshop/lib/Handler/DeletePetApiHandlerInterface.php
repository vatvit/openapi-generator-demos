...
use PetshopApi\Api\DeletePetApiHandlerInterfaceServiceInterface;
use Handler\DeletePetValidator;
use Response\DeletePet204Response;
use Response\DeletePet0Response;
...
class DeletePetHandler implements RequestHandlerInterface
{
    public function __construct(
        private readonly DeletePetApiHandlerInterfaceServiceInterface $service,
