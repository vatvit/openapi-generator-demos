# PetShopApi\Api\AnalyticsApiInterface

All URIs are relative to *https://petstore.swagger.io/v2*

Method | HTTP request | Description
------------- | ------------- | -------------
[**findPets**](AnalyticsApiInterface.md#findPets) | **GET** /pets | 
...
services:
    # ...
    Acme\MyBundle\Api\AnalyticsApi:
        tags:
            - { name: "open_api_server.api", api: "analytics" }
    # ...
```
...
```php
<?php
// src/Acme/MyBundle/Api/AnalyticsApiInterface.php
...
class AnalyticsApi implements AnalyticsApiInterface
{
    ...
    /**
     * Implementation of AnalyticsApiInterface#findPets
     */
