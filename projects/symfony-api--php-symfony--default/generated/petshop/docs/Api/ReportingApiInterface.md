# PetShopApi\Api\ReportingApiInterface

All URIs are relative to *https://petstore.swagger.io/v2*

Method | HTTP request | Description
------------- | ------------- | -------------
[**findPets**](ReportingApiInterface.md#findPets) | **GET** /pets | 
...
services:
    # ...
    Acme\MyBundle\Api\ReportingApi:
        tags:
            - { name: "open_api_server.api", api: "reporting" }
    # ...
```
...
```php
<?php
// src/Acme/MyBundle/Api/ReportingApiInterface.php

namespace Acme\MyBundle\Api;

use PetShopApi\Api\ReportingApiInterface;
...
class ReportingApi implements ReportingApiInterface
{
    ...
    /**
     * Implementation of ReportingApiInterface#findPets
     */
