 ...
 * @author   openapi-generator contributors
 * @link     https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \TicTacToeApi\TicTacToeApi\Api\StatisticsApiInterface
 */
class StatisticsApiInterfaceTest extends WebTestCase
{
    ...
    public function testGetLeaderboard(): void
    {
        ...
        $this->markTestSkipped('Test for getLeaderboard not implemented');
    }

    /**
     * Test case for getPlayerStats
     *
    ...
    public function testGetPlayerStats(): void
    {
        ...
        $crawler = $client->request('GET', $path);
        $this->markTestSkipped('Test for getPlayerStats not implemented');
    }
