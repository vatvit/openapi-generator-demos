...
use TicTacToeApi\TicTacToeApi\Model\NotFoundError;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \TicTacToeApi\TicTacToeApi\Model\NotFoundError
 */
class NotFoundErrorTest extends TestCase
{
    protected NotFoundError|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(NotFoundError::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(NotFoundError::class));
        $this->assertInstanceOf(NotFoundError::class, $this->object);
    }
