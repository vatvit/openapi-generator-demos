...
use TicTacToeApi\TicTacToeApi\Model\ValidationError;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \TicTacToeApi\TicTacToeApi\Model\ValidationError
 */
class ValidationErrorTest extends TestCase
{
    protected ValidationError|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(ValidationError::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(ValidationError::class));
        $this->assertInstanceOf(ValidationError::class, $this->object);
    }
