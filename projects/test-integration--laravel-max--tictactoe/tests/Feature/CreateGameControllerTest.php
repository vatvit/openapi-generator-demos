...
use TictactoeApi\Api\Handlers\GameManagementApiHandler;  // Handler interface (GameManagementApi + Handler)
...
class CreateGameControllerTest extends TestCase
{
    ...
    public function test_controller_delegates_to_handler(): void
    {
        ...
        $controllerPath = __DIR__ . '/../../../../generated/laravel-max/tictactoe/app/Http/Controllers/CreateGameController.php';
