...
namespace TictactoeApi\Security;
...
class SecurityValidator
{
    ...
    private static array $securitySchemes = [
        'defaultApiKey' => DefaultApiKeyInterface::class,
        'basicHttpAuthentication' => BasicHttpAuthenticationInterface::class,
        'bearerHttpAuthentication' => BearerHttpAuthenticationInterface::class,
        'app2AppOauth' => App2AppOauthInterface::class,
        'user2AppOauth' => User2AppOauthInterface::class,
    ];
