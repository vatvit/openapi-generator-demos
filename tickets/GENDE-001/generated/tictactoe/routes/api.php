 ...
 *         \TictactoeApi\Http\Middleware\AuthenticateBearerHttpAuthentication::class,
 *     ]);
 * })
 * ```
 *
 ...
 */
$route = $router->POST('/games', \TictactoeApi\Http\Controllers\CreateGameController::class)
    ->name('api.createGame');
 ...
 * - bearerHttpAuthentication (http)
 */
$route = $router->DELETE('/games/{gameId}', \TictactoeApi\Http\Controllers\DeleteGameController::class)
    ->name('api.deleteGame');
 ...
 * - bearerHttpAuthentication (http)
 */
$route = $router->GET('/games/{gameId}', \TictactoeApi\Http\Controllers\GetGameController::class)
    ->name('api.getGame');
 ...
 * - bearerHttpAuthentication (http)
 */
$route = $router->GET('/games', \TictactoeApi\Http\Controllers\ListGamesController::class)
    ->name('api.listGames');
 ...
 * - app2AppOauth (oauth2)
 */
$route = $router->GET('/games/{gameId}/board', \TictactoeApi\Http\Controllers\GetBoardController::class)
    ->name('api.getBoard');
 ...
 * - bearerHttpAuthentication (http)
 */
$route = $router->GET('/games/{gameId}/moves', \TictactoeApi\Http\Controllers\GetMovesController::class)
    ->name('api.getMoves');
 ...
 */
$route = $router->GET('/games/{gameId}/board/{row}/{column}', \TictactoeApi\Http\Controllers\GetSquareController::class)
    ->name('api.getSquare');
 ...
 * - user2AppOauth (oauth2)
 */
$route = $router->PUT('/games/{gameId}/board/{row}/{column}', \TictactoeApi\Http\Controllers\PutSquareController::class)
    ->name('api.putSquare');
 ...
 */
$route = $router->GET('/leaderboard', \TictactoeApi\Http\Controllers\GetLeaderboardController::class)
 ...
 * - bearerHttpAuthentication (http)
 */
$route = $router->GET('/players/{playerId}/stats', \TictactoeApi\Http\Controllers\GetPlayerStatsController::class)
...
if (config('app.debug', false)) {
    ...
    if (class_exists(\TictactoeApi\Security\SecurityValidator::class)) {
        try {
            \TictactoeApi\Security\SecurityValidator::validateMiddleware($router);
