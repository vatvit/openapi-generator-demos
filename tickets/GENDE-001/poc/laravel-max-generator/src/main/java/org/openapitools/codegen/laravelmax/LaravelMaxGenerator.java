...
public class LaravelMaxGenerator extends AbstractPhpCodegen implements CodegenConfig {
  ...
  public OperationsMap postProcessOperationsWithModels(OperationsMap objs, List<ModelMap> allModels) {
    ...
    for(CodegenOperation op : opList){
      ...
      controllerTask.put("outputDir", apiFileFolder());
      ...
      if (op.bodyParam != null && op.bodyParam.baseType != null && !op.bodyParam.baseType.isEmpty()) {
        ...
        formRequestTask.put("outputDir", outputFolder + "/Http/Requests");
      ...
      for(CodegenResponse response : op.responses) {
        ...
        task.put("outputDir", outputFolder + "/" + resourceFileFolder());
  ...
  public void processOpts() {
    ...
    // Re-add only the files we actually want
  ...
  /**
   * Location to write model files: Models/ directory
   */
  ...
  /**
   * Location to write api files: Http/Controllers/ directory
   */
  @Override
  ...
  /**
   * Location to write resource files: Http/Resources/ directory (relative to output folder)
   */
