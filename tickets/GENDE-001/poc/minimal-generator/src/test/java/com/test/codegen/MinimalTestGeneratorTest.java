 ...
 * 1) Set a break point in MinimalTestGenerator.java in the postProcessOperationsWithModels() method.
 * 2) To launch this test in Eclipse: right-click | Debug As | JUnit Test
 *
 */
public class MinimalTestGeneratorTest {
  ...
  public void launchCodeGenerator() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
              .setGeneratorName("minimal-test") // use this codegen library
              ...
              .setOutputDir("out/minimal-test"); // output directory
